 %% MUniCS-doc.tex
%% Copyright 2020 Felipe Gil-Castiñieira 
%
% Derived from cleanthesis-doc by R. Langner
%
...
\titlepage{%
  title={The \sty{MUniCS Master's Thesis} Package},
  subtitle={A \LaTeX Style for MUniCS Master's Thesis Documents},
  url={\cthesishome},
  author={Felipe Gil-Castiñeira},
  email={felipe@uvigo.gal},
  revision={0.1.0},
  date={2020/01/07}}

\hypersetup{%
  pdftitle={The \munics Package},
  pdfsubject={A LaTeX Style for MUniCS Master's Thesis Documents},
  pdfauthor={Felipe Gil-Castiñeira},
...
\subsection[About]{About \sty{MUniCS Master's Thesis template}}
\label{sec:intro:about}

\subsection{License}
\label{sec:intro:license}

Copyright \textcopyright\ 2020 Felipe Gil-Castiñeira
...
This work is \textbf{strongly} based on the ``cleanthesis'' template by R. Langner (\url{https://github.com/derric/cleanthesis}) and the ``Yet Another Thesis Template'' by Alex Povel (\url{https://github.com/alexpovel/thesis_template}). 
...
\subsection{Overleaf}
This package was specially designed to be used in Overleaf (\url{http://www.overleaf.com}). 

\subsection{Latexmk}
Latexmk is a Perl script that completes the different steps to compile a \LaTeX source code. The \texttt{latexmkrc} file contains the settings for this project. 
